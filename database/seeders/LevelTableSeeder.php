...
class LevelTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $level_3=['level'=>3,'exp'=>100,'hp'=>200];
        $level_4=['level'=>4,'exp'=>200,'hp'=>400];
        $level_5=['level'=>5,'exp'=>400,'hp'=>800];
        $level_6=['level'=>6,'exp'=>800,'hp'=>1600];
        $level_7=['level'=>7,'exp'=>3200,'hp'=>3200];
